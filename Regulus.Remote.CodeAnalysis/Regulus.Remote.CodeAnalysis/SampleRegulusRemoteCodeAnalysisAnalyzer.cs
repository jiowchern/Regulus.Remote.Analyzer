...
namespace Regulus.Remote.CodeAnalysis
{
    ...
    public class SampleRegulusRemoteCodeAnalysisAnalyzer : DiagnosticAnalyzer
    {
        public const string DiagnosticId = "SampleRegulusRemoteCodeAnalysis";
        ...
        public override ImmutableArray<DiagnosticDescriptor> SupportedDiagnostics { get { return ImmutableArray.Create(UpperRule); } }
        public SampleRegulusRemoteCodeAnalysisAnalyzer()
        {
